...
- Basic formatting (Phase 2): bold, italic, text colour from a small palette shared with the canvas, and paragraph alignment (left, centre, right). Nothing else: no font sizes, lists or links. The text stays on the lines whatever the formatting.
